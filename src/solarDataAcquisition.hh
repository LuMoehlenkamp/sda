...
const std::string GET_REQUEST =
    GET + BLANK + SOLAR_PATH + BLANK + HTTP_VERSION + CRLF + HOST + BLANK +
    SOLAR_HOST + CRLF + ACCEPT + BLANK + ACCEPT_VALUE + CRLF + CONNECTION +
    BLANK + CONNECTION_CLOSE_VALUE + CRLF + CRLF;
